		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ZAMM_BED_OCCUP-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zamm_bed_occup-display": {
								"semanticObject": "zamm_bed_occup",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zamm_bed_occup",
									"url": sap.ui.require.toUrl("zamm_bed_occup")
								}
							}
						}
					}
